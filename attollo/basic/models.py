...
class Student(Person):
    ...
    age = models.IntegerField(
        validators=[MinValueValidator(1)], verbose_name="Age")
    ...
    year_in_school = models.CharField(
        max_length=2, choices=YEAR_IN_SCHOOL_CHOICES, default=FRESHMAN, verbose_name="Year in school")
    ...
    def get_fields_forsearch(self):
        ...
        # takes out id and name and person pointer
        neededfields = allfields[1:4] + allfields[5:]
...
class Employee(Person):
    # just a variable I found online, honestly don't think we need it
